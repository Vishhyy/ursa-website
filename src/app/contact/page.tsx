            ...
            <FadeIn>
                ...
                <div className="flex justify-center gap-6 md:gap-8 mt-12 md:mt-16 pb-12">
                    ...
                    <a
                        ...
                        className="p-3 md:p-4 bg-white shadow-md border border-gray-100 rounded-full text-accent hover:bg-accent hover:text-white hover:-translate-y-1 transition-all"
                    >
                        <Instagram size={24} />
                    </a>
